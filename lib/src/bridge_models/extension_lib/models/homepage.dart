...
class $HomePageData implements HomePageData, $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        ExtensionLibTypes.homePageData.library, 'HomePageData.', $new);
    runtime.registerBridgeFunc(ExtensionLibTypes.homePageData.library,
        'HomePageData.fromMap', $fromMap);
  }
...
class $HomePageRequest implements HomePageRequest, $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        ExtensionLibTypes.homePageRequest.library, 'HomePageRequest.', $new);
  }
...
class $HomePage implements HomePage, $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        ExtensionLibTypes.homePage.library, 'HomePage.', $new);
  }
...
class $HomePageList implements HomePageList, $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        ExtensionLibTypes.homePageList.library, 'HomePageList.', $new);
  }
