...
class $MediaItem implements MediaItem, $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        ExtensionLibTypes.mediaItem.library, 'MediaItem.', $new);
  }

  static const $type = BridgeTypeRef(ExtensionLibTypes.mediaItem);
...
class $MediaItemType implements $Instance {
  ...
  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeEnumValues(
        ExtensionLibTypes.mediaItemType.library, 'MediaItemType', $values);
  }

  static const $type = BridgeTypeRef(ExtensionLibTypes.mediaItemType);
