...
class $SHA512 implements $Instance {
  $SHA512.wrap(this.$value);

  late final _superclass = $Hasher.wrap($value);

  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(CryptoDartTypes.sha512.library, 'SHA512.', $new);
  }

  static const $type = BridgeTypeRef(CryptoDartTypes.sha512);
  ...
  static $Value? $new(Runtime runtime, $Value? target, List<$Value?> args) {
    return $SHA512.wrap(SHA512(args[0]?.$reified));
  }
