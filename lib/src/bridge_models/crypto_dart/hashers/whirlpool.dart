...
class $WHIRLPOOL implements $Instance {
  $WHIRLPOOL.wrap(this.$value);

  late final _superclass = $Hasher.wrap($value);

  static void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc(
        CryptoDartTypes.whirlpool.library, 'WHIRLPOOL.', $new);
  }

  static const $type = BridgeTypeRef(CryptoDartTypes.whirlpool);
  ...
  static $Value? $new(Runtime runtime, $Value? target, List<$Value?> args) {
    return $WHIRLPOOL.wrap(WHIRLPOOL(args[0]?.$reified));
  }
