...
class MediaItem {
  ...
  bool get isMovie => type == MediaItemType.Movie;

  bool get isTvSeries => type == MediaItemType.TvSeries;

  bool get isAnime => type == MediaItemType.Anime;

  bool get isManga => type == MediaItemType.Manga;

  bool get isNovel => type == MediaItemType.Novel;
}
